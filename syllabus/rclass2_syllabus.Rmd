...
- Office hours:
  - Zoom office hours: Tuesdays 1pm-2pm, zoom [link]()
  - And by appointment
...
The course will be structured around weekly asynchronous (pre-class) lectures and one online synchronous workshop-style class meeting per week. Weekly homework will consist of students working through the lectures on their own, a modest amount of required reading, and weekly problem sets completed in groups of three.
