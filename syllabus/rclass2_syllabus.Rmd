...
For the first two weeks of the course, we will have synchronous lectures and class time will be on TBD. In the subsequent weeks, we will have asynchronous (pre-class) lectures and a synchronous workshop-style class that meets on TBD. 
