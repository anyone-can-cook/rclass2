...
We will be recording all lectures on Zoom with Zoom captions enabled. However, it is possible that we have had class recordings from previous years posted that do not have captioning. Thus, if you encounter a recording on our website that does not include captioning, please enable Google Chrome Live Caption. 

Google Chrome live caption uses AI to caption any videos playing on your Google Chrome browser, and is simple to set up. You can find detailed instructions on how to enable live caption on this link: https://support.google.com/chrome/answer/10538231?hl=en
