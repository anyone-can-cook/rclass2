...
Similarly, the __`scale_y_continuous()`__ to control the display of the y-axis when y is a continuous variable
...
```
- Alternatively, we could specificy scale like this: `scale = .001`:
...
- non-data display means stuff not determined by values of the data
...
<br>
We can also use [`theme()`](https://ggplot2.tidyverse.org/reference/theme.html) to customize specific non-data components of the plot.
