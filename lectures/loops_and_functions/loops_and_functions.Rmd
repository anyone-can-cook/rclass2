...
ipeds <- readLines(url('https://raw.githubusercontent.com/anyone-can-cook/rclass2/master/data/ipeds/ipeds_file_list.txt'))
#str(ipeds)
...
load(url("https://github.com/anyone-can-cook/rclass2/raw/master/data/recruiting/recruit_event_somevars.RData"))
