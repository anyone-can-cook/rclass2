...
- Modify function to take an arbitrary number of names to greet
    ...
    print_hello2("Dasher", "Dancer", "Prancer", "Vixen", "Joyce Nguy", "Taylor Swift")
...
assess_price(price = 10)
cheap <- assess_price(price = 10)
cheap

assess_price(price = 2000)
assess_price(price = 2000) %>% str()
p <- assess_price(price = 2000)
p
```
...
tables <- diamond_info_by_color('E')
