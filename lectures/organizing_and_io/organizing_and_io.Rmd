...
df_school <- readRDS(file = url(description = 'https://github.com/anyone-can-cook/rclass2/raw/master/data/recruiting/recruit_school_somevars.RDS'))
```
...
load(file = url(description = 'https://github.com/anyone-can-cook/rclass2/raw/master/data/recruiting/recruit_school_somevars.RData'))
```
