...
The following quotes text from __R for Data Science__ [14.4 Tools](https://r4ds.had.co.nz/strings.html#tools):
...
- For example, below I load a data frame created from [Table 208.30](https://nces.ed.gov/programs/digest/d21/tables/dt21_208.30.asp) of the NCES Digest of Education Statistics
- Notice that in the resulting data frame, the variable `state` has lots of periods `.` after the name of the state
- __How could we use regular expressions to get rid of those periods?__
```{r}
...
str_detect(string = "P. Sherman, 42 Wallaby Way, Sydne", pattern = "\\d")
```
