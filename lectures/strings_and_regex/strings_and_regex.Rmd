...
- **Print using the `writeLines()` function**
    - This shows the string text as it is meant to be read by the end user
    - This does not show the enclosing double quotes (`"`) around the string
...
- How can we **match all occurrences of times** in the following string? (i.e., `10 AM` & `1 PM`)
